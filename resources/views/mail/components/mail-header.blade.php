...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <style type="text/css">
      ...
      #emailBody{background-color:#FFFFFF; margin-top:100px;}
      ...
      @media only screen and (max-width: 480px){
        ...
        table[id="emailBody"]{margin-top:0 !important; min-height:700px !important;} 
  ...
  <center style="background-color:#E1E1E1;">
      <table border="0" cellpadding="0" cellspacing="0" height="auto" width="100%" id="bodyTbl" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
        <tr>
                              ...
                              <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                <tr>
                                  <td align="center" valign="top" class="textContent">
                                   <h2 style="text-align:center;font-weight:bold;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#ffffff;line-height:135%;">Ic-Admin</h2>
                                  </td>
                                </tr>
                              </table>
                            </td>
